...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \pgfplotstableread[col sep=comma]{../code/wan/results/low_prob/plot_data.dat}\datatable
            \addplot+[
                mark = none,
                color = red,
            ]
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \pgfplotstableread[col sep=comma]{../code/wan/results/low_prob_fix2/plot_data.dat}\datatable
            \addplot+[
                mark = none,
                color = red,
            ]
