...
\end{equation}
where $\ket{\psi_1}$ is a state of interest, the goal is to estimate its amplitude $a = \lvert\bra{\psi_1}\ket{\psi_1}\rvert^2$.

In its original formulation \cite{brassard2002}, it was proven that the amplitude can be estimated with an additive error of
\begin{equation}
...
Later variants have been proposed to reduce the qubits needed and circuit depths \cite{suzuki2020, nakaju2020, grinko2021}, making it more feasible for NISQ devices.
