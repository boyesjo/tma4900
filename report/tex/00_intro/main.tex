...
Thereafter, the more general field of reinforcement learning and its mathematical formulation as Markov decision processes are introduced, along with several state-of-the-art algorithms based on deep learning and artificial neural networks.
