...
But also model-based algorithms have seen some commendable results recently, for example, in \textit{Minecraft}~\autocite{minecraft}, being able to find diamonds~\autocite{hafner2023}.
