...
Generalising amplitude estimation, in \autocite{montanaro2015}, a near-quadratic speed-up of Monte Carlo methods was achieved by using amplitude estimation to estimate the mean of a random variable encoded by quantum algorithms.
...
In particular, for these bounded random variables, $O(1/\epsilon)$ iterations suffices to achieve an additive error of $\epsilon$, repeating the whole procedure $O(1/\log(\delta))$ times to achieve a certainty $1-\delta$ \autocite{montanaro2015}.