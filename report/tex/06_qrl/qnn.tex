...
The expressive power of models heavily relies on the encoding strategy.
...
It is therefore not straightforward to translate the classical recurrent neural network (RNN) to a variational quantum circuit in the manner of \cref{fig:qnn} and the above discussed architectures.
