...
However, the simulations done for this project show that the algorithm is only effective on what can be considered \enquote{hard} instances of the bandit problem, id est those in which reward means are close for which many samples will be needed to thoroughly distinguish between them.
