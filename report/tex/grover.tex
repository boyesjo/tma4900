...
\begin{center}
    \begin{tikzpicture}
        ...
        \coordinate (S) at (5,0);
        \coordinate (W) at (0,5);
        \coordinate (P) at ({5*cos(20)}, {5*sin(20)});
...
\begin{center}
    \begin{tikzpicture}
        ...
        \coordinate (W) at (0,5);
        \coordinate (P) at ({5*cos(20)}, {5*sin(20)});
        \coordinate (P2) at ({5*cos(20)}, {5*sin(-20)});
...
\begin{center}
    \begin{tikzpicture}
        ...
        \coordinate (P) at ({5*cos(20)}, {5*sin(20)});
        \coordinate (P2) at ({5*cos(20)}, {5*sin(-20)});
        \coordinate (P3) at ({5*cos(60)}, {5*sin(60)});
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \coordinate (S) at (3,0);
        \coordinate (W) at (0,3);
        \coordinate (P) at ({3*cos(20)}, {3*sin(20)});
        ...
        \coordinate (S) at (8,0);
        \coordinate (W) at (5,3);
        \coordinate (P) at ({5+3*cos(20)}, {3*sin(20)});
        \coordinate (P2) at ({5+3*cos(20)}, {3*sin(-20)});
        ...
        \coordinate (S) at (3,-5);
        \coordinate (W) at (0,-2);
        \coordinate (P) at ({3*cos(20)}, {-5+3*sin(20)});
        \coordinate (P2) at ({3*cos(20)}, {-5+3*sin(-20)});
        \coordinate (P3) at ({3*cos(60)}, {-5+3*sin(60)});
