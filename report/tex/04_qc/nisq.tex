...
\begin{figure}
  ...
  \begin{tikzpicture}
    \begin{groupplot}[
        ...
        % % colour blue
        % colormap={blueblue}{color(0cm)=(blue); color(1cm)=(blue)},
        % colour red
        colormap={redred}{color(0cm)=(red); color(1cm)=(red)},
      ]
      \nextgroupplot
      \addplot3[
        opacity = 0.35,
...
This noise is very hard to avoid, as controlling the qubits necessarily requires some outside interaction with the environment.
