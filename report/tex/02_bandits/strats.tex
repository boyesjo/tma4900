...
\begin{table}
    \centering
    \captionabove[
        Comparison of strategies for the multi-armed bandit problem.
    ]
    {
        Comparison of strategies for the unstructured, stochastic multi-armed bandit problem.
        The minimax regret is the instance-indepedent upper bound, while the regret is the dependent.
