            ...
            \begin{subfigure}{0.4\textwidth}
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \pgfplotstableread[col sep=comma]{../code/bandit_figs/ucb/ucb_\turn.csv}\datatable
                        \addplot+[
                            only marks,
                            error bars/.cd,
                            y dir=plus,
    ...
    \begin{tikzpicture}
        \begin{groupplot}[
            ...
            \addplot table[
                    ...
                    y=y1,
                    col sep=comma,
                ] {../code/bandit_figs/thompson/thompson_0.csv};
            ...
            \addplot table[
                    ...
                    y=y1,
                    col sep=comma,
                ] {../code/bandit_figs/thompson/thompson_10.csv};
            ...
            \addplot table[
                    ...
                    y=y1,
                    col sep=comma,
                ] {../code/bandit_figs/thompson/thompson_100.csv};
            ...
            \addplot table[
                    ...
                    y=y1,
                    col sep=comma,
                ] {../code/bandit_figs/thompson/thompson_1000.csv};
