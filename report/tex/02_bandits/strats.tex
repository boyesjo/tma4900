...
\begin{table}[tbp]
    ...
    ]
    {
        ...
        Also, note that the Thompson sampling properties listed assume Bernoulli rewards and a uniform prior.
    }
...
\subsubsection{UCB1 for bounded rewards}
...
\begin{figure}
    ...
    ]
    {
        ...
        The algorithms were run for 1000 turns, and the regrets are averaged over 1000 instances.
    }
