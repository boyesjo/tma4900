...
For policies obeying this property, the Lai-Robbins bound \autocite{lai1985} holds, namely that
\begin{equation}
...
\begin{equation}
    \liminf_{T\to\infty} \frac{R_T}{\ln T} \geq \sum_{a \in \mathcal{A}}\frac{\Delta_a}{D(P_a \mathrel{\Vert} P^*)}.
